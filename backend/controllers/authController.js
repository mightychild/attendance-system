...
exports.signup = catchAsync(async (req, res, next) => {
  ...
  // 3) For students, check if universityId is provided and unique
  if (universityId) {
  ...
  // 4) Create the new user (role defaults to 'student' from the schema)
  ...
  // 5) Log the user in immediately after signup (generate token)
